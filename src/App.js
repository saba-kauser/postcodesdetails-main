...
function App() {
  ...
  return (
    ...
    <div className="App">
      ...
      <h1 className='text-center mb-4 mt-4 bg-red bg-light'>Postcode Search</h1>
        <div className='form component'>
          <h4>Please enter a postcode *</h4>
          <form className="input-group mb-3" id="postcodeform"> 
            <input className="" type='text' placeholder='SE1 0BX' value={enteredPostCode} onChange={(e)=>setEnteredPostCode(e.target.value)} required="required"/>
             <div>
